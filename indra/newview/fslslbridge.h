...
// visible form, and it is somebody else's unmarked script besides.
const std::string FS_BRIDGE_NAME = "#Lumen LSL Bridge v";

// The name Lumen used to create, kept ONLY so the old one can be found and
// cleaned up on the first run after upgrading. Everything already in the
